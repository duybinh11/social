...
const Display: FC<DisplayProps> = ({changeBackgroundColor, changeColorScheme}): ReactElement => {
    ...
    const [selectedBackgroundColor, setSelectedBackgroundColor] = React.useState<BackgroundTheme>(BackgroundTheme.LIGHTS_OUT);
    const [selectedColor, setSelectedColor] = React.useState<ColorScheme>(ColorScheme.YELLOW);
