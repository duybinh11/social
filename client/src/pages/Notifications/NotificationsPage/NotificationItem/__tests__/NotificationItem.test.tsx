...
describe("NotificationItem", () => {
    ...
    it("should render like NotificationItem", () => {
        ...
        expect(wrapper.text().includes(`${mockNotificationLike.user.username} đã thích bài viết của bạn`)).toBe(true);
    ...
    it("should render retweet NotificationItem", () => {
        ...
        expect(wrapper.text().includes(`${mockNotificationRetweet.user.username} Đã đăng lại bài viết của bạn`)).toBe(true);
    });
